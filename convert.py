...
# parser.add_argument('config_path', help='Path to Darknet cfg file.',default='yolov3.cfg')
# parser.add_argument('weights_path', help='Path to Darknet weights file.', default='yolov3.weights')
